      ...
      <header className="w-full">
        ...
        <Row gutter={[32, 0]}>
          {suggestions.map((suggestion: Suggestion) => (
            ...
            >
              <div
                className="flex flex-row gap-3 items-center justify-between bg-n-7 rounded-lg w-full h-full p-4 shadow-md cursor-pointer hover:shadow-lg transition duration-300 ease-in-out hover:-translate-y-1"
