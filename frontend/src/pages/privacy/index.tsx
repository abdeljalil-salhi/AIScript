 ...
 *
 * @interface PrivacyPageProps
 * @returns {JSX.Element} - PrivacyPage Component
 * @exports PrivacyPage
 */
export const PrivacyPage: FC<PrivacyPageProps> = (): JSX.Element => {
  useDocumentTitle("AIScript - Privacy Policy");

  return (
    <>
      <Helmet>
        <title>AIScript - Privacy Policy</title>
        <meta
          name="description"
          content="Our Privacy Policy describes our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You."
        />
      </Helmet>
      ...
      <div className="w-full flex items-start justify-center p-4 md:p-6">
        <div className="w-full max-w-5xl text-base font-['Poppins'] flex flex-col gap-5 pb-20 text-justify">
          ...
          <p className="caption text-n-4 lg:block font-['Poppins'] italic">
          ...
          <ul className="list-disc list-inside">
            ...
            <li className="ml-4 mb-4">
              ...
              in this Agreement) refers to AIScript.
            </li>
            <li className="ml-4 mb-4">
            ...
            <li className="ml-4 mb-4">
              <strong>Website</strong> refers to AIScript, accessible from{" "}
              <a
          ...
          <ul className="list-disc list-inside">
            <li className="ml-4 mb-4">Email address</li>
            <li className="ml-4 mb-4">Usage Data</li>
          </ul>
          ...
          <ul className="list-disc list-inside">
            <li className="ml-4 mb-4">Google</li>
            <li className="ml-4 mb-4">Facebook</li>
            <li className="ml-4 mb-4">Instagram</li>
            <li className="ml-4 mb-4">Twitter</li>
            <li className="ml-4 mb-4">LinkedIn</li>
          </ul>
          ...
          <ul className="list-disc list-inside">
            <li className="ml-4 mb-4">Comply with a legal obligation</li>
            <li className="ml-4 mb-4">
            ...
            <li className="ml-4 mb-4">Protect against legal liability</li>
          </ul>
          ...
          <ul className="list-disc list-inside">
            <li className="ml-4 mb-4">
              ...
              <a
                href={`${import.meta.env.VITE_API_BASE_URL}/contact`}
                rel="external nofollow noopener"
                target="_blank"
                className="text-n-3 hover:text-n-1 transition-all underline hover:underline"
              >
